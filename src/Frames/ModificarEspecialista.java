 ...
 */
public class ModificarEspecialista extends javax.swing.JFrame {
    ...
    private boolean existeEspecialista(){
        ...
        try{
            ...
            ps = con.prepareStatement("SELECT * FROM especialista where  nombre = ? AND ap_paterno =? AND ap_materno = ? AND sexo =? AND edad=? AND cedula =?");
            ...
            ps.setString(5, spinnerEdad.getValue().toString());            
           
            ps.setString(6, textCedula.getText());
    ...
    private void registrarEspecialista(){
        ...
        try{
            ...
            if(res > 0){               
               JOptionPane.showMessageDialog(null, "Se modificó correctamente su registro");
               Login login = new Login();
               login.setVisible(true);
               buscarPaciente.setVisible(false);
               dispose();
            }else{
                JOptionPane.showMessageDialog(null,"No se pudieron modificar los datos del especialista");
            } 
            ps.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarEspecialista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarEspecialista(new BuscarPaciente()).setVisible(true);
            }
        });
    }
